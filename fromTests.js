...
function displayHoldsQueueInTerminal (holdsQueue) {
...
function processHoldsData (requestedResources) {
  ...
  if (holds.length > 0) {
    ...
    console.log('holds count: ' + holdsQueue.length)
  }
}
